      ...
      <div className="hidden lg:flex flex-col justify-between p-10 bg-surface-muted border-r border-border">
        ...
        <div>
          <h2 className="text-3xl font-semibold tracking-tight leading-tight max-w-md">
            Run the numbers.{" "}
            <span className="text-brand">Grow the business.</span>
          </h2>
          <p className="mt-3 text-sm text-muted-foreground max-w-md">
            A single place to plan monthly budgets, track spending, manage your
            team, and print reports — built for Pomegrid.
          </p>
        </div>
